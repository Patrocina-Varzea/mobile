  ...
  return (
    <Animated.View
      className={`
        ...
        m-2 mb-1 w-52 transform rounded-lg p-4 transition-all
      `}
      style={{
        opacity: 0.95,
        transform: [
    ...
    >
      <Text className="text-center font-subtitle text-white">{message}</Text>
      {showProgress && (
...
function ToastProvider({
  ...
  return (
    <ToastContext.Provider value={{ toast, removeToast }}>
      {children}
      <View
        className={cn("absolute left-0 right-0 items-center justify-center", {
